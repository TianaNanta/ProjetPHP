...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">NetworkSurvey</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">ProjetPHP</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= route_to('user.tables'); ?>" class="nav-link <?= (current_url() == base_url('user/tables')) ? 'active' :''; ?>">
          ...
          <li class="nav-item">
            <a href="<?= route_to('user.contacts'); ?>" class="nav-link <?= (current_url() == base_url('user/contacts')) ? 'active' :''; ?>">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="<?= base_url();?>">NetworkSurvey</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
